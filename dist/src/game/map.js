    ...
    constructor(game, mapId) {
        ...
        if (!data_1.Debug.disableMapGeneration) {
            ...
            while (x < 700) {
                ...
                // Crossing bunker
                if (x === 360) {
                    this.genStructure("bunker_structure_05", data_1.Objects.bunker_structure_05, (0, planck_1.Vec2)(x, y), 1);
                }
                // River docks
                if (x === 400) {
                    this.genBuilding("dock_01", data_1.Objects.dock_01, (0, planck_1.Vec2)(x, y - 13), 0, 0);
                }
                // Fisherman's shacks
                if (x === 300 || x === 500) {
                    this.genBuilding("shack_03a", data_1.Objects.shack_03a, (0, planck_1.Vec2)(x, y - 25), 0, 0);
                }
                // Large bridges
                if (x === 200 || x === 600) {
                    this.genBuilding("bridge_lg_01", data_1.Objects.bridge_lg_01, (0, planck_1.Vec2)(x, y), 1, 0);
                }
                // Smaller river
                if (x === 440) {
                    let x2 = 500;
        ...
        if (!data_1.Debug.disableMapGeneration) {
            // Docks
            this.genOnShore(constants_1.ObjectKind.Building, "warehouse_complex_01", 1, 72, 0, 1);
            // Conch bunker
            this.genOnShore(constants_1.ObjectKind.Structure, "bunker_structure_04", 1, 36, 0, 1);
            // Huts
            this.genOnShore(constants_1.ObjectKind.Building, "hut_01", 3, 27, 1);
            ...
            this.genOnShore(constants_1.ObjectKind.Building, "hedgehog_01", 40, 57, 4);
            this.genOnShore(constants_1.ObjectKind.Building, "shack_03b", 2, 57, 1);
            // Barrels & crates
            // TODO Allow barrels and crates to spawn on the beach naturally
            this.genOnShore(constants_1.ObjectKind.Obstacle, "crate_01", 12, 57, 4);
            this.genOnShore(constants_1.ObjectKind.Obstacle, "barrel_01", 12, 57, 4);
            // Treasure chest
    ...
    genStructure(typeString, structureData, setPosition, setOrientation) {
        ...
        if (structureData.layers != null) {
            for (let layerId = 0, length = structureData.layers.length; layerId < length; layerId++) {
                ...
                layerObjIds.push(data_1.TypeToId[layerType]);
        ...
        this.game.staticObjects.add(new structure_1.Structure(this.game, typeString, position, orientation, layerObjIds));
